document.addEventListener("DOMContentLoaded", async function(){
    ...
    document.getElementById("last-vet-visit-date").textContent = lastVetVisit
        ...
        : "N/A";
    document.getElementById("other-health-info").textContent = health?.health_desc || "None";
    document.getElementById("other-vaccination-info").textContent = health?.vacc_desc|| "None";
